...
target_compile_options(${PROJECT_NAME} PUBLIC -O2 -Wno-switch -sUSE_FREETYPE=1 -sUSE_SDL=2)
...
set_target_properties("${PROJECT_NAME}" PROPERTIES LINK_FLAGS "-O2 -s USE_SDL=2 -s OFFSCREEN_FRAMEBUFFER=0 -s ALLOW_MEMORY_GROWTH -s USE_FREETYPE=2 -s EXIT_RUNTIME=1 -s STACK_SIZE=524288 -s --preload-file \"${CMAKE_SOURCE_DIR}/res\"@res --shell-file \"${CMAKE_CURRENT_BINARY_DIR}/shell.html.in\"")
