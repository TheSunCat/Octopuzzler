...
public:
    OpenGL()
    {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, SCR_WIDTH / 2, SCR_HEIGHT / 1.5, 0, GL_RGB, GL_UNSIGNED_BYTE, nullptr);
        ...
        glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, SCR_WIDTH / 2, SCR_HEIGHT / 1.5);
