...
{
    // TODO race condition :c
    // BAD BAD BAD BAD. We need to do this later because else it says it's not complete
    Util::doLater([this]{ this->scaleResolution(glm::vec2(1)); }, 100);
}
